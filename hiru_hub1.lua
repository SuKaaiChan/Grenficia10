...
local Window = Fluent:CreateWindow({
    Title = "Grenficia Hub",
    SubTitle = "Version Beta 5 | By Sukaichan",
    TabWidth = 160,
...
Tabs.home:AddButton({
        Title = "Youtube",
        Description = "Đăng Ký Kênh YouTube Di Pls",
        Callback = function()
            setclipboard("https://www.youtube.com/@SuKaiChanHi")
        end
    })
    
Tabs.home:AddButton({
        Title = "Nhom Discord",
        Description = "Vô Để Xem Update!",
        Callback = function()
            setclipboard("https://discord.gg/Y7XMTANz")
        end
    })
